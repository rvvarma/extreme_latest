...
@Component({
  selector: 'app-parentassignment',
  templateUrl: './parentassignment.component.html',
  styleUrls: ['./parentassignment.component.css']
})
export class ParentassignmentComponent implements OnInit {
  assignment=[];
    sub=[];
    ass=[];
    assign=[]
    ...
    constructor(private http: Http,private _cookieService:CookieService,private httpService: HttpClient) { }
